...
class AutoScaleTabBarView extends StatefulWidget {
  ...
  @override
  State<AutoScaleTabBarView> createState() => AutoScaleTabBarViewState();
}

class AutoScaleTabBarViewState extends State<AutoScaleTabBarView> {
  ...
  Future<void> warpToCurrentIndex({
    bool force = false,
  }) async {
    ...
    if (!force) assert((_currentIndex! - previousIndex).abs() > 1);
    ...
    if (!force) _pageController.jumpToPage(initialPage);
